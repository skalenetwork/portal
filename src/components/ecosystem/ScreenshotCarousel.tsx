...
const ScreenshotCarousel: React.FC<PropType> = ({ screenshots, appName }) => {
  ...
  return (
    <Box position="relative" className="mt-2.5">
      ...
      >
        <ArrowBackIosNewRoundedIcon className="text-secondary-foreground/60 styles.chainIconxs" />
      </IconButton>
      <IconButton
        onClick={scrollNext}
      ...
      >
        <ArrowForwardIosRoundedIcon className="text-secondary-foreground/60 styles.chainIconxs" />
      </IconButton>
    </Box>
  )
}
