...
export default function AppCard(props: {
  ...
  return (
    <SkPaper gray={gray} fullHeight className="sk-app-card w-full transform transition-all duration-300 ease-in-out hover:scale-101 hover:shadow-md hover:-translate-y-0.5">
      <Link to={url}>
        <div>
          <div className="flex">
            <Logo
