    ...
    <div>
      ...
      {loading ? (
        ...
        <Button
          ...
          variant="contained"
          className="bg-accent-foreground! disabled:bg-muted-foreground/30! dark:disabled:bg-muted-foreground/30! text-accent! disabled:text-muted! btnMd mt-2.5! mb-1! w-full!"
          onClick={stake}
        >
          {getBtnText()}
        </Button>
