        ...
        unstakeAllBtn={
          hasActiveDelegations ? (
            <Button
              ...
              className="font-sans! bg-foreground/10! py-2! px-3! capitalize! text-destructive! font-semibold! text-xs! ease-in-out transition-transform duration-150 active:scale-[0.97] hover:scale-[1.01] disabled:bg-foreground/5! disabled:text-foreground/40! disabled:cursor-not-allowed! disabled:transform-none! disabled:hover:scale-100!"
            >
