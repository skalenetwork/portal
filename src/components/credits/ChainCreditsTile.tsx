                      ...
                      tokenPrices[tokenData.address] && (
                        <div key={symbol}>
                          <Button
                            color="primary"
                            size="small"
                            className={`items-center mr-2.5! p-4! py-3! pr-5! rounded-full! uppercase btnLg bg-accent-foreground/20! text-foreground! ease-in-out transition-transform duration-150 active:scale-[0.97] ${symbol !== token ? 'bg-card!' : ''} ${symbol !== token ? 'text-foreground!' : ''}`}
                            variant="contained"
