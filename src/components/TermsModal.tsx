    ...
    <div className="h-[calc(100vh-120px)] md:h-[calc(100vh-102px)] flex flex-col overflow-hidden">
      ...
      >
        ...
        <Button
          ...
          variant="contained"
          disabled={!scrolled}
          className="w-full mt-3! md:mt-4! mb-12! md:mb-0! capitalize! text-[13px]! md:text-sm! font-semibold! py-3.5! md:py-4! bg-accent-foreground! text-accent! disabled:bg-accent-foreground/50! ease-in-out transition-transform duration-150 active:scale-[0.97]"
          size="large"
        >
          {getAgreeButtonText()}
        </Button>
