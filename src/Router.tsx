...
export default function Router() {
  ...
  const setTransfersHistory = useMetaportStore(
    (state) => state.setTransfersHistory,
  );
  ...
  return (
    <Routes>
      ...
      <Route
        path="chains"
        element={
          <Network loadSchains={loadSchains} schains={schains} mpc={mpc} />
        }
      />
      <Route path="chains">
        <Route
          path=":name"
          element={
            <Schain loadSchains={loadSchains} schains={schains} mpc={mpc} />
          }
        />
      </Route>
