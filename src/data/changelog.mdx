...
Seamless integration with Trails enabling one-click bridging to SKALE Base with automatic conversion to USDC and credits purchase completion.

[Check it out](/bridge)

#### 🌉 Bridge UX Improvements

Improved messaging, added loading states and better Exit Gas Wallet threshold calculation.

#### ⚡ Exit Gas Wallet Refill UX Improvements
