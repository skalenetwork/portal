...
#### 🔋 Added “Get sFUEL” Button
A new Get sFUEL button has been added to the header for quick access.It is only visible if the wallet is connected and is disabled for users who already have sFUEL on all four Hub Chains.
