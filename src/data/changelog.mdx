...
Managing delegations just got easier! You can now take bulk actions, like unstaking—across all delegations to the same validator in one go.
...
Quickly disconnect your wallet via a new “Disconnect” button, now easily accessible next to “Manage Wallet”.
