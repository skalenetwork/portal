...
Added loading indicators, clearer explanations, and fixes idle UI after transaction confirmation for gas wallet refills.

#### 🚨 Global Alert System

Introduced stackable bottom-right notifications for system events, transactions, errors, and status updates.
