...
function temporarySuccess(message: string, toastId?: string | number) {
  toast.success(message, {
    ...
    id: toastId,
    className:
      'text-emerald-500! dark:text-emerald-400! bg-emerald-100! dark:bg-emerald-400/15! backdrop-blur-md!'
  })
}
...
function temporaryInfo(message: string, toastId?: string | number) {
  toast.info(message, {
    ...
    id: toastId,
    className:
      'text-sky-500! dark:text-blue-400! bg-sky-100! dark:bg-blue-400/15! backdrop-blur-md!'
  })
}
...
function permanentError(message: string, toastId?: string | number) {
  toast.error(message, {
    duration: Infinity,
    id: toastId,
    className: 'text-red-500! dark:text-red-400! bg-red-100! dark:bg-red-400/15! backdrop-blur-md!'
  })
}
